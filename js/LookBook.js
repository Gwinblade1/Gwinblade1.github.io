function defaultLoad(){
    let elementsMenuLookbook = document.querySelectorAll(".lookbook-filter__item");
    let elementSort = document.querySelector(".lookbook-filter__sort-btn");
...
function sortBtn(elementSort, filterMenu){
    elementSort.onclick = function(){
        elementSort.classList.toggle("lookbook-filter__sort-btn--active");
